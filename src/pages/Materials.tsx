...
const Materials: React.FC = () => {
  ...
  const loadMaterials = async () => {
    ...
    setMaterials(data); // Removed client-side sort to rely on DB order or re-add if needed
    setLoading(false);
  };
  ...
  const handleUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Temporary object to pass data, file is passed separately
      ...
      alert('Erro ao fazer upload. Verifique as configurações do Supabase.');
      console.error(error);
    } finally {
      setUploading(false);
    }
