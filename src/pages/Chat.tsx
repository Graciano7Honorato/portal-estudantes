    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          // Notify Layout (if needed via Broadcast for red dot, though now redundant if all tabs are open)
          // Ideally, we keep the BroadcastChannel JUST for the "unread" notification in Layout, 
          // or we move the Supabase Subscription to Layout.tsx. 
          // For now, we notify the layout via the existing channel mechanism for simplicity.
